...
public:
    ...
    static vector <clsCurrency> FindAllByCode(string CurrencyCode)
    {
        vector <clsCurrency> vAllWithSameCurrencyCode;
        CurrencyCode = clsString::UpperAllString(CurrencyCode);
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                ...
                if (Currency.CurrencyCode() == CurrencyCode)
                {
                    vAllWithSameCurrencyCode.push_back(Currency);
                }
            }
        ...
        return vAllWithSameCurrencyCode;
